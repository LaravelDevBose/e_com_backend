                                        ...
                                        <table id="wishlist-table" class="clean-table linearize-table data-table">
                                            ...
                                            <tbody>
                                                <tr id="item_31" class="first odd">
                                                    <td class="wishlist-cell0 customer-wishlist-item-image"><a title="ThinkPad Ultrabook" href="#/" class="product-image"> <img width="150" alt="ThinkPad X1 Ultrabook" src="{{asset('front/images/product-img.jpg')}}"> </a></td>
                                                ...
                                                <tr id="item_33" class="odd">
                                                    <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Softwear Women's Designer" href="#" class="product-image"> <img width="150" alt="Softwear Women's Designer" src="{{asset('front/images/product-img.jpg')}}"> </a></td>
                                                    <td class="wishlist-cell1 customer-wishlist-item-info">
                                                ...
                                                <tr id="item_32" class="last even">
                                                    <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Noise Smart Watch " href="#" class="product-image"> <img width="150" alt=" Noise Smart Watch " src="{{asset('front/images/product-img.jpg')}}"> </a></td>
                                                    <td class="wishlist-cell1 customer-wishlist-item-info">
