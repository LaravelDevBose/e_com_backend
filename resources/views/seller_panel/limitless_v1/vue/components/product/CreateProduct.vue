        ...
        <div class="content">
            ...
            <div v-show="cat_Selected">
                ...
                <div class="panel panel-warning" v-if="formData.product_type === 1">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Images: <span class="text text-danger text-bold h4">*</span></label>
                ...
                <div class="panel panel-warning" v-if="formData.product_type === 2">
                    ...
                    <div class="panel-body">
                        <div v-for="i in total" :key="i" :id="i" class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" v-show="pri_id[i]">
