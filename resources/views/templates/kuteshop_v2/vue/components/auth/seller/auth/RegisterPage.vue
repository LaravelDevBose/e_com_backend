<template>
    <div class="box-authentication">
        ...
        <form action="" @submit.prevent="sellerRegister">
            <div class="row">
                <div class="col-md-10">
                    <label for="shop_name">Shop Name <span class="text text-danger text-bold">*</span></label>
                    <input type="text" v-model="formData.shop_name" placeholder="Shop name" required class="form-control" id="shop_name">
                </div>
                <div class="col-md-10">
