                    ...
                    <form method="post" action="#updatePost/">
                        ...
                        <fieldset>
                            <table class="data-table cart-table" id="shopping-cart-table">
                                ...
                                <tr class="first odd">
                                    <td class="image">
                                        <a class="product-image" title="ThinkPad X1 Ultrabook" href="#/women-s-crepe-printed-black/">
                                            <img width="75" alt="ThinkPad Ultrabook" src="{{ asset('crocus_v2') }}">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr class="last even">
                                    <td class="image"><a class="product-image" title="QX30 Lens Camera" href="#women-s-u-tank-top/"><img width="75" alt="Sample Product" src="{{ asset('crocus_v2/images/product-img.jpg') }}"></a></td>
