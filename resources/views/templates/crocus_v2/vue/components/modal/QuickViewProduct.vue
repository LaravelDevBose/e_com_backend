<template>
    <div class="modal fade quickView" id="quickView" tabindex="-1" role="dialog" aria-labelledby="absentCleaner" aria-hidden="true">
        <div class="modal-dialog model-md modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="product-view" v-if="showModal">
