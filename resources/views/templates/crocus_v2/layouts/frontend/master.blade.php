...
<div id="app">
    <div id="page">
        ...
        <header>
            <!-- header -->
            @include('templates.crocus_v2.layouts.frontend.includes.globalHeader')
            <!-- end header -->

            <!-- Navigation -->
            @include('templates.crocus_v2.layouts.frontend.includes.navigation')
            <!-- end nav -->
        </header>
        <!-- end Header Section -->
        ...
        <!-- Footer -->
        @include('templates.crocus_v2.layouts.frontend.includes.globalFooter')
        <!-- End Footer -->
    </div>

        <!-- mobile menu -->
        @include('templates.crocus_v2.layouts.frontend.includes.mobileMenu')
        <!-- end mobile menu -->
