                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                <br>
                                                                <input type="text" title="Street Address" name="billing[street][]" id="billing:street1  street1" value="Hunts Ville" class="input-text required-entry">
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <div class="input-box">
                                                                    ...
                                                                    <br>
                                                                    <input type="text" title="City" name="billing[city]" value="MG" class="input-text required-entry" id="billing:city">
                                                                </div>
