                    ...
                    <div class="sidebar-content" style="padding-bottom:0px;">
                        ...
                        <div class="panel-body bg-indigo-400 border-radius-top text-center" style="background-image: url(http://demo.interface.club/limitless/assets/images/bg.png); background-size: contain;">
                            ...
                            <a href="#" class="display-inline-block content-group-sm">
                                <img v-if="shopInfo.shop_logo"
                                     :src="shopInfo.shop_logo.image_path"
                                     class="img-circle img-responsive"
                                     :alt="shopInfo.shop_name " style="width: 110px; height: 110px;">
                            </a>
                        ...
                        <div class="panel no-border-top no-border-radius-top " style="margin-bottom:0px;">
                            <ul class="navigation">
                                ...
                                <li class="active"><a href="#info" data-toggle="tab"><i class="icon-store"></i>Shop Info</a></li>
                                <li><a href="#products" data-toggle="tab"><i class="icon-bag"></i> Products</a></li>
                                <li><a href="#orders" data-toggle="tab"><i class="icon-cart"></i> Orders</a></li>
                    ...
                    <div class="content-detached">
                        ...
                        <div class="tab-content">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="table-responsive content-group">
                                                            <table class="table table-striped table-sm">
                                                                <tbody>
                                                                <tr>
                                                                    <td class="text-info-800" style="width:30px"><i class="icon-store2"></i></td>
                                                                    <td>
                                                                        <span>{{ shopInfo.shop_name }}</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-info-800" style="width:30px"><i class="icon-envelope"></i></td>
                                                                    <td>
                                                                        <span>{{ shopInfo.shop_email }}</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-info-800" style="width:30px"><i class="icon-phone"></i></td>
                                                                    <td>
                                                                        <span>{{ shopInfo.phone_no }}</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-info-800" style="width:30px"><i class="icon-location4"></i></td>
                                                                    <td>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="table-responsive content-group">
                                                            <table class="table table-striped table-sm">
                                                                <tbody>
                                                                <tr>
                                                                    <td class="text-info-800" style="width:30px"><i class="icon-user"></i></td>
                                                                    <td>
                            ...
                            <div class="tab-pane fade" id="products">
                                <shop-products-section></shop-products-section>
                            </div>
                            <div class="tab-pane fade" id="orders">
                                <shop-orders-section></shop-orders-section>
                            </div>
...
<script>
    ...
    import ShopOrdersSection from "./ShopOrdersSection";
    ...
    export default {
        ...
        components: {ShopOrdersSection, ShopProductsSection, InvoiceModalView},
        data(){
            return{
                reqData:{
                    shop_id:'',
