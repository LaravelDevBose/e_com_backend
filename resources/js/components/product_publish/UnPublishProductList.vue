                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <div class="form-inline" style="margin:1em;">
                                ...
                                <div class="form-group">
                                    <button type="button" @click.prevent="selectDateRange('today')" class="btn btn-sm btn-outline-primary">
                                        <span>Today</span>
                                    </button>
                                </div>
                                <div class="form-group">
                                    <button type="button" @click.prevent="selectDateRange('week')" class="btn btn-sm btn-outline-primary">
                                        <span>This Week</span>
                                    </button>
                                </div>
                                <div class="form-group">
                                    <button type="button" @click.prevent="selectDateRange('month')" class="btn btn-sm btn-outline-primary">
                                        <span>This Month</span>
                                    </button>
                                </div>
                                <div class="form-group">
                                    <button type="button" @click.prevent="selectDateRange('custom')" class="btn btn-sm btn-outline-primary">
                                        <span>Custom Date</span>
                                    </button>
                                </div>

                                <div class="form-group" v-if="custom_date">
